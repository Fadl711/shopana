            ...
            <div class="col-lg-4 col-md-8 col-sm-8">
                <div class="footer__newslatter">
                    ...
                    <div class="footer__social">
                        <a href="https://www.facebook.com/share/18YPvqY6AR/" target="_blank"><i
                                class="fa fa-facebook"></i></a>
                        {{--                         <a href="#"><i class="fa fa-twitter"></i></a> --}}
                        {{--                         <a href="#"><i class="fa fa-youtube-play"></i></a>
 --}} <a href="https://www.instagram.com/alyaser_shopp?igsh=cTdzZWJyZGtxNGw3"><i
            ...
            <div class="col-lg-12">
                ...
                <div class="footer__copyright__text">
                    <p>حقوق النشر &copy;
                        ...
                        </script> جميع الحقوق محفوظة لـ ANA Shop <i class="fa fa-heart"
                            aria-hidden="true"></i>
                    </p>
                </div>
                <!-- لا يمكن إزالة الرابط الخاص بـ Colorlib. القالب مرخص بموجب CC BY 3.0. -->
