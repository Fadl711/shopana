...
<div class="container">
    ...
    <!-- store_address = before route for cash in delivery -->
        <form action="{{ route('submit.order') }}" method="POST" id="paymentForm">
            @csrf

            <h2 style="padding-bottom:20px;"> مكان التوصيل</h2>
{{--
            ...
            <div class="form-group">
                ...
                <input type="text" id="City" name="city" value="صنعاء" required>
            </div>
...
{{--             <div class="form-group">
            ...
            <h2 style="padding-bottom:20px;"> معلومات العميل</h2>

            <div class="form-group">
                <label for="contact_name">الاسم:</label>
                <input type="text" id="contact_name" name="contact_name" value="{{Auth::user()->name}}" required>
            </div>

            <div class="form-group">
                <label for="contact_number">رقم الهاتف</label>
                <input type="text" id="contact_number" name="contact_number" value="{{Auth::user()->contact}}" required>
            </div>
